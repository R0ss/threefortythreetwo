...
public class JDBCExample {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            // Make the connection to the database, ****** but replace
            // "username" with your username ******
            System.out.println("*** Please make sure to replace 'username' with your cdf username in the jdbc connection string!!!");
            connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/csc343h-c9truong", "c9truong", "");
        ...
        try {
            ...
            sqlText = "INSERT INTO jdbc_demo   " + "VALUES (4, 'Five')";
            System.out.println("Executing this command: \n" + sqlText.replaceAll("\\s+", " ") + "\n");
            sql.executeUpdate(sqlText);

            // ---------------------------------------------------------------------------------------
            // Upate values of jdbc_demo
            sqlText = "UPDATE jdbc_demo      " + "   SET text = 'Four'  " + " WHERE  code = 4      ";
            System.out.println("Executing this command: \n" + sqlText.replaceAll("\\s+", " ") + "\n");
            sql.executeUpdate(sqlText);
